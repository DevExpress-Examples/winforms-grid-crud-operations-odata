...
'			Me.gridControl1.EmbeddedNavigator.ButtonClick += New DevExpress.XtraEditors.NavigatorButtonClickEventHandler(Me.OnEmbeddedNavigatorButtonClick);
			...
			Me.View.Name = "View"
'			Me.View.RowUpdated += New DevExpress.XtraGrid.Views.Base.RowObjectEventHandler(Me.OnRowUpdated);
			' 
			' colProductID
			' 
